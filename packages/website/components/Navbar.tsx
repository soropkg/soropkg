...
export default function Navbar() {
  ...
  return (
    <nav style={{
      ...
      {/* Yellow rule at very top — Stellar brand element */}
      ...
      <div style={{
        ...
        <a href="#" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none" }}>
          {/* Logo mark — yellow S monogram on black */}
          <div style={{
            width: 30, height: 30, borderRadius: 4,
            background: "var(--yellow)",
            display: "flex", alignItems: "center", justifyContent: "center",
          }}>
            <span style={{ fontFamily: "'Lora', serif", fontWeight: 700, fontSize: 16, color: "#0F0F0F", lineHeight: 1 }}>
              S
            </span>
          </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
          {[["Features", "#features"], ["How it works", "#how-it-works"], ["Registry", "#ecosystem"]].map(([label, href]) => (
            <a key={label} href={href} style={{
              ...
              fontWeight: 400, padding: "6px 14px", borderRadius: 4,
